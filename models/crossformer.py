...
def build_transformer(config):
    ...
    input_length = int(config['model']['seq_length_s'] / config['model']['samp_interval_s']) + 1

    model = Crossformer(
        data_dim=config['model']['input_dim'],  # Number of dimensions of the MTS data 54, Abla: {9, 12, 13, 14,}
        in_len=input_length,  # Length of input/history sequence
